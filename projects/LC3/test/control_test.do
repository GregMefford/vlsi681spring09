...
force INSTRUCTION 4'hX;
run
echo "\nTest R3 = R1 + R5"
force INSTRUCTION 'b0001011001000101;
force STAGE 0;
run;
if {[examine ALU_CONTROL] != "0000"} { # ADD Instruction
...
if {[examine IR_LE] != "St0"} { # Don't store next instruction
...
if {[examine IR_LE] != "St1"} { # Store a new instruction
...
force STAGE 0;
run;
if {[examine ALU_CONTROL] != "0001"} { # AND Instruction
...
force STAGE 0;
run;
if {[examine ALU_CONTROL] != "0010"} { # NOT Instruction
...
force STAGE 0;
run;
if {[examine ALU_CONTROL] != "0100"} { # MUL Instruction
...
force STAGE 0;
run;
if {[examine ALU_CONTROL] != "0110"} { # SL Instruction
...
force STAGE 0;
run;
if {[examine ALU_CONTROL] != "0101"} { # SR Instruction
